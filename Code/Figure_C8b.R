...
colLab = function(n, labelColors, clusMember) { 
   ...
   n 
	...
	cluster.file = paste("R-base_Clustering_plots/Euclidian_Distance_Complete_",output.prefix,"_Hierarchical_Clustering_WITH_NA.png",sep="")
		#cor.mat = cor(as.matrix(var.mat), use="pairwise.complete.obs")
		#dis.mat = 1 - cor.mat
		#dist1 = as.dist(dis.mat)
		
		dist1 = dist(as.matrix(t(var.mat)))
